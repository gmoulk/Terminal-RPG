...
int main(){
	...
	Spirit* spr = new Spirit("Spirit", 0 , 10, 1, 0, 2, 0.1);
	Exosceleton* exo = new Exosceleton("Exo", 2 , 10, 13, 12, 1, 0.1);
	...
	Potion* pt =  new Potion(0,1,"AP",0.8,3);
	Monster* teamEnemy[3];
//	teamEnemy[0] = drg;
//	teamEnemy[1] = spr;
	teamEnemy[0] = exo;
	monsters_squad* team3 = new monsters_squad(teamEnemy,1);
