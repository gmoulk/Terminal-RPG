...
class Hero : public Living{
	...
	public:
		Hero(string nameI, int healthPowerI,int magicPowerI, int strengthI, int dexterityI, int agilityI) : Living(nameI,healthPowerI,0) , 
			...
			experienceForLevelUp(30), numOfItems(0), armInUse(NULL), wpInUse1(NULL), wpInUse2(NULL) {}
...
class Warrior : public Hero{
	public:
		Warrior(string nameI) : Hero(nameI,100,80,10,5,10) {
		}
...
class Sorcerer : public Hero{
	public:
		Sorcerer(string nameI) : Hero(nameI,70,110,5,10,10) {
		}
...
class Paladin : public Hero{
	public:
		Paladin(string nameI) : Hero(nameI,90,95,10,10,5) {
		}
